...
// scripts/debug_mma.ts
import fs from "fs";
var SEARCH_URL = "https://work.mma.go.kr/caisBYIS/search/byjjecgeomsaek.do";
async function fetchDebugHTML() {
  console.log("Fetching MMA HTML for debugging...");
  try {
    const response = await axios_default.post(SEARCH_URL, new URLSearchParams({
      pageUnit: "10",
      pageIndex: "1",
      eopjong_gbcd: "1",
      menu_id: "m_m6_1"
