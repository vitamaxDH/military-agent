...
// scripts/scrapers/jumpit.ts
import fs from "fs";
var SEARCH_URL = "https://www.jumpit.co.kr/search";
async function fetchJumpitDebug() {
  console.log("Fetching Jumpit HTML...");
  try {
    const response = await axios_default.get(SEARCH_URL, {
      params: {
        keyword: "\uC0B0\uC5C5\uAE30\uB2A5\uC694\uC6D0"
      },
      headers: {
    ...
    fs.writeFileSync("debug_jumpit.html", response.data);
